    ...
    const updateQuantity = async (productId, quantity) => {
     ...
     const handlePayment = async (amounts) => {
        try {
            ...
            const options = {
                key: "rzp_test_WgxamtVupSULV6", // Replace with your RazorPay Key ID
                amount: amount,
                currency: currency,
                name: "E-commerce",
                ...
                cart  ? 
                  <div className="row">
                    ...
                    <div className="col-6">
                        ...
                        <button className='btn btn-success' onClick={() => handlePayment(cart?.totalAmount)}>Pay Now</button>
                    </div>
                </div>
                :
                <h1>No product is cart</h1>
              }
            </div>
        </>
    )
